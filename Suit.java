...
*/
public final static java.util.List VALUES = Collections.unmodifiableList(Arrays.asList( new Suit[] { CLUBS, DIAMONDS, HEARTS, SPADES } ) );
...
public int suitValue() {
	...
	if (this.getName().equals("Spades"))
	{
		return 4; 
	}
	else if (this.getName().equals("Clubs"))
	{
		return 1;
	}
	else if (this.getName().equals("Diamonds"))
	{
		return 2;
	}
	else if (this.getName().equals("Hearts"))
	{
		return 3;
	}
	else {
...
public int compareTo( Object otherSuitObject ) {
   ...
   return (this.suitValue() ) - (otherSuit.suitValue());
} 
